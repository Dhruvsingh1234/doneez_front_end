      ...
      subItems: [
        ...
        // Engine (Full List)
        {
          ...
          services: [
            ...
            { id: '1-3-13', name: 'Timing Chain Tensioner Replacement' },
        ...
        // Auto Maintenance (Full List)
        {
          ...
          services: [
            ...
            { id: '1-7-19', name: 'Serpentine Belt/Drive Belt Replacement' },
        ...
        // Steering & Suspension (Full List)
        {
          ...
          services: [
            ...
            { id: '1-8-12', name: 'Suspension Arm/Bushing Replacement' },
        ...
        // Transmission & Drivetrain (Full List)
        {
          ...
          services: [
            ...
            { id: '1-9-19', name: 'Front/Rear Wheel Drive System Service' },
        ...
        // Software Updates
        {
          ...
          services: [
            { id: '1-11-1', name: 'EV Battery Management System Update' },
        ...
        // Hybrid Diagnostics
        {
          ...
          services: [
            ...
            { id: '1-13-3', name: 'Regenerative Braking System Diagnosis' },
        ...
        // Electric Motor Repairs
        {
          ...
          services: [
            ...
            { id: '1-14-3', name: 'High Voltage Cable Inspection and Repair' },
            { id: '1-14-4', name: 'Transmission/Gearbox Repair/Replacement' },
        ...
        // Performance Tuning
        {
          ...
          services: [
            { id: '1-15-1', name: 'Performance Tuning for EV & Hybrid Powertrains' },
            { id: '1-15-2', name: 'Custom Electric Motor Upgrades' },
            { id: '1-15-3', name: 'Software Tuning for Improved Efficiency' },
            { id: '1-15-4', name: 'Performance Exhaust Installation (Hybrid)' },
            { id: '1-15-5', name: 'Suspension Upgrades for EVs' },
            { id: '1-15-6', name: 'Custom Wheel and Tire Packages for EVs' },
        ...
        subItems: [
          // Dent Repair (Completed)
          {
            ...
            services: [
              ...
              { id: '2-1-3', name: 'Traditional Dent Repair (with Body Filler)' },
          ...
          // Collision Repair
          {
            ...
            services: [
              ...
              { id: '2-2-8', name: 'Windshield Replacement After Collision' },
          ...
          // Bumper Repair/Replacement
          {
            ...
            services: [
              ...
              { id: '2-3-3', name: 'Bumper Replacement (OEM and Aftermarket)' },
          ...
          // Auto Body Painting
          {
            ...
            services: [
              ...
              { id: '2-4-7', name: 'Paint Protection Film (PPF) Installation' },
              { id: '2-4-8', name: 'Ceramic Coating for Paint Protection' },
              { id: '2-4-9', name: 'Vinyl Wrapping (for Custom Graphics)' },
          ...
          // Hail Damage Repair
          {
            ...
            services: [
              { id: '2-5-1', name: 'Paintless Dent Repair (PDR) for Hail Damage' },
              { id: '2-5-2', name: 'Traditional Dent Repair (with Body Filler)' },
              { id: '2-5-3', name: 'Windshield Chip Repair' },
              { id: '2-5-4', name: 'Hail Damage Respray' },
              { id: '2-5-5', name: 'Hail Damage Assessment and Estimation' },
          ...
          // Additional Auto Body Services
          {
            ...
            services: [
              ...
              { id: '2-8-33', name: 'Splash Guard Backing Plate Replacement' },
              { id: '2-8-34', name: 'Rear Lift Gate Locking Mechanism' },
              { id: '2-8-35', name: 'Rear Distance Sensor Replacement' },
              { id: '2-8-36', name: 'Door Weather Stripping Replacement' },
        ...
        subItems: [
          {
            ...
            services: [
              ...
              { id: '3-1-2', name: 'Aftermarket Bumpers (Front and Rear)' },
              { id: '3-1-3', name: 'Custom Grilles and Grille Guards' },
              { id: '3-1-4', name: 'Fender Flares and Wheel Arch Extensions' },
              { id: '3-1-5', name: 'Custom Spoilers and Roof Scoops' },
              { id: '3-1-6', name: 'Hood Vents and Custom Hoods' },
              { id: '3-1-7', name: 'Custom Side Steps and Running Boards' },
          ...
          },
          {
            ...
            services: [
              ...
              { id: '3-2-6', name: 'Overland Lighting (LED Light Bars, Spotlights)' },
          ...
          },
          {
            ...
            services: [
              ...
              { id: '3-3-7', name: 'Suspension Bushings and Arm Upgrades' },
          ...
          },
          {
            ...
            services: [
              { id: '3-4-1', name: 'Custom Upholstery (Leather, Suede, Fabric)' },
              { id: '3-4-2', name: 'Seat Replacement (Heated and Cooled Seats)' },
              { id: '3-4-3', name: 'Custom Dashboard and Console Modifications' },
              { id: '3-4-4', name: 'Steering Wheel Upgrades' },
              { id: '3-4-5', name: 'Floor Mats and Liners (Custom Fit)' },
              { id: '3-4-6', name: 'Interior Lighting (LED Kits, Ambient Lighting)' },
              { id: '3-4-7', name: 'Soundproofing and Insulation' },
              { id: '3-4-8', name: 'Custom Interior Trim (Wood, Carbon Fiber, Aluminum)' },
              { id: '3-4-9', name: 'Custom Seat Covers' },
              { id: '3-4-10', name: 'Aftermarket Entertainment System Installation' },
            ]
          },
          {
            ...
            services: [
              ...
              { id: '3-5-2', name: 'Turbocharger and Supercharger Upgrades' },
              { id: '3-5-3', name: 'Performance Exhaust System (Cat-back, Axle-back)' },
              { id: '3-5-4', name: 'Performance Tuning and ECU Remapping' },
              { id: '3-5-5', name: 'High-Performance Brakes' },
              { id: '3-5-6', name: 'Upgraded Intercoolers' },
              { id: '3-5-7', name: 'Fuel System Upgrades' },
              { id: '3-5-8', name: 'Performance Camshaft and Crankshaft Replacement' },
              { id: '3-5-9', name: 'Headers and High-Flow Catalytic Converters' },
              { id: '3-5-10', name: 'Upgraded Radiators and Oil Coolers' },
            ]
          },
          {
            ...
            services: [
              ...
              { id: '3-6-2', name: 'Advanced Infotainment Systems (Apple CarPlay, Android Auto)' },
              ...
              { id: '3-6-7', name: 'Aftermarket Stereo Systems and Speakers' },
              { id: '3-6-8', name: 'LED and HID Headlight Upgrades' },
              { id: '3-6-9', name: 'Smartphone Integration and Bluetooth' },
              { id: '3-6-10', name: 'Adaptive Cruise Control Installation' },
            ]
          },
          {
            title: "Protection and Maintenance",
            services: [
              { id: '3-7-1', name: 'Ceramic Coating for Paint Protection' },
              { id: '3-7-2', name: 'Paint Protection Film (PPF) Installation' },
              { id: '3-7-3', name: 'Rust Proofing and Undercoating' },
              { id: '3-7-4', name: 'Clear Bra Installation (Front End Protection)' },
          ...
          },
          {
            ...
            services: [
              ...
              { id: '3-8-4', name: 'Vintage Upholstery and Interior Restoration' },
              { id: '3-8-5', name: 'Restoration of Classic Car Trim and Chrome' },
              { id: '3-8-6', name: 'Body Panel Repair and Replacement for Classic Cars' },
              { id: '3-8-7', name: 'Rebuild and Restore Classic Suspensions' },
              { id: '3-8-8', name: 'Restoration of Classic Wheels and Rims' },
              { id: '3-8-9', name: 'Upgrading Classic Car Electronics (Custom Radios, Gauges)' },
              { id: '3-8-10', name: 'Classic Car Re-Painting and Refinishing' },
            ]
          },
          // "Click to See More..." Services
          {
            ...
            services: [
              { id: '3-9-1', name: 'Custom Lighting (Underbody, Off-Road, LED)' },
              { id: '3-9-2', name: 'Aftermarket Grills and Front Fascia Customization' },
              { id: '3-9-3', name: 'Performance Clutch Upgrades' },
              { id: '3-9-4', name: 'Custom Exhaust Tips and Mufflers' },
              { id: '3-9-5', name: 'Aftermarket Rear Bumper and Tow Bar Installations' },
              { id: '3-9-6', name: 'Aftermarket Sunroof or Moonroof Installation' },
              { id: '3-9-7', name: 'Custom Fenders and Wheel Wells' },
              { id: '3-9-8', name: 'Vehicle Lift and Jacking Systems' },
              { id: '3-9-9', name: 'Customized Floorboard and Pedal Kits' },
              { id: '3-9-10', name: 'Body Armor and Off-Road Protection Accessories' },
            ]
          }
        ]
      },
        ...
        subItems: [
          {
            ...
            services: [
              ...
              { id: '4-1-5', name: 'Paint Protection Film (PPF) Application' },
              { id: '4-1-6', name: 'Ceramic Coating for Exterior Protection' },
              { id: '4-1-7', name: 'Headlight Restoration' },
              { id: '4-1-8', name: 'Tar and Bug Removal' },
              { id: '4-1-9', name: 'Wheel and Tire Cleaning and Protection' },
              { id: '4-1-10', name: 'Wheel Well Cleaning and Protection' },
          ...
          },
          {
            ...
            services: [
              ...
              { id: '4-3-4', name: 'Battery Cleaning and Terminals Check' },
              { id: '4-3-5', name: 'Radiator Grill and Engine Surface Cleaning' },
            ]
          },
          {
            ...
            services: [
              ...
              { id: '4-4-6', name: 'Wheel Protection Application (Ceramic Coating or Sealant)' },
            ]
          },
          {
            title: "Glass and Mirror Detailing",
            services: [
              { id: '4-5-1', name: 'Exterior Window Cleaning and Polishing' },
              { id: '4-5-2', name: 'Interior Window Cleaning' },
              { id: '4-5-3', name: 'Windshield Treatment (Water Repellent)' },
          ...
          },
          {
            ...
            services: [
              { id: '4-7-1', name: 'Paint Protection Film (PPF) Installation' },
              { id: '4-7-2', name: 'Ceramic Coating for Paint Protection' },
          ...
          },
          {
            ...
            services: [
              ...
              { id: '4-8-6', name: 'Detailing for Classic and Vintage Cars' },
        ...
        subItems: [
          // Tire Services
          {
            ...
            services: [
              ...
              { id: '5-1-10', name: 'TPMS (Tire Pressure Monitoring System) Service' },
            ]
          },
          // Wheel Services
          {
          ...
          // Tire and Wheel Maintenance
          {
            ...
            services: [
              ...
              { id: '5-3-2', name: 'Wheel and Tire Protection Application (Ceramic Coating)' },
              { id: '5-3-3', name: 'Tire Shine Application' },
              { id: '5-3-4', name: 'Tire Pressure Monitoring System (TPMS) Sensor Replacement' },
              { id: '5-3-5', name: 'Valve Stem Replacement' },
              { id: '5-3-6', name: 'Wheel Hub and Bearing Inspection/Replacement' },
            ]
          },
